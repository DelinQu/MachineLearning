...
def show(dataxArr, ydata, b1, b3):  # 显示函数
    ...
    for i in range(n):
        if ydata[i] == 'Iris-setosa':
            xcord1.append(dataxArr[i, 0]);
            ycord1.append(dataxArr[i, 1])
        elif ydata[i] == 'Iris-versicolor':
            xcord2.append(dataxArr[i, 0]);
            ycord2.append(dataxArr[i, 1])
        else:
            xcord3.append(dataxArr[i, 0]);
            ycord3.append(dataxArr[i, 1])
...
############################################################
    ...
    ax.scatter(xcord2, ycord2, s=30, c='#00FF00', marker='o', label="Iris-versicolor")
    ax.scatter(xcord3, ycord3, s=30, c='r', marker='o', label='Iris-virginica')
...
if __name__ == '__main__':
    xdata, ydata1, ydata2, ydata3, ylabe = loadData('./iris/iris.data')         # 加载数据
